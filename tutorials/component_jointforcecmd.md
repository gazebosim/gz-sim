...
[joint integration test](https://github.com/gazebosim/gz-sim/blob/main/test/integration/joint.cc),
the \ref gz::sim::systems::ApplyJointForce system
([source code](https://github.com/gazebosim/gz-sim/tree/main/src/systems/apply_joint_force)),
and others.

The corresponding world SDF is [`apply_joint_force.sdf`](https://github.com/gazebosim/gz-sim/blob/main/examples/worlds/apply_joint_force.sdf), which you can look at in Gazebo:
