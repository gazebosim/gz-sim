...
but users can make use of templating tools like [ERB](https://github.com/gazebosim/gz-sim/blob/main/tutorials/erb_template.md)
...
(For more details, see the [Server configuration tutorial](https://github.com/gazebosim/gz-sim/blob/main/tutorials/server_config.md)
and the [GUI configuration tutorial](https://github.com/gazebosim/gz-sim/blob/main/tutorials/gui_config.md)).
