...
<model name='vehicle_blue'>
  ...
  <plugin
    filename="ignition-gazebo-diff-drive-system.so"
...
```xml
<plugin filename="ignition-gazebo-triggered-publisher-system.so"
...
<model name="trigger">
    ...
    <plugin
      filename="ignition-gazebo-touchplugin-system.so"
    ...
    <plugin filename="ignition-gazebo-detachable-joint-system.so"
...
```xml
    <world>
      ...
      <plugin
        filename="ignition-gazebo-contact-system.so"
...
```xml
    <world>
      ...
      <plugin filename="ignition-gazebo-altimeter-system.so"
