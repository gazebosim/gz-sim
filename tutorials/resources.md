...
3. [Systems that are installed with Ignition Gazebo](https://ignitionrobotics.org/api/gazebo/3.7/namespace gz_1_1gazebo_1_1systems.html)
...
5. [Plugins which are installed with Ignition GUI](https://ignitionrobotics.org/api/gui/3.0/namespace gz_1_1gui_1_1plugins.html)
