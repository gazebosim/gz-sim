...
[built-in systems](https://github.com/gazebosim/gz-sim/tree/main/src/systems)
and [integration tests](https://github.com/gazebosim/gz-sim/blob/main/test/integration)
in the source code.
Most of the built-in systems have a corresponding example SDF world.
You can find all the example worlds [here](https://github.com/gazebosim/gz-sim/tree/main/examples/worlds).
...
- Source code of [built-in systems](https://github.com/gazebosim/gz-sim/tree/main/src/systems)
- Source code of [example worlds](https://github.com/gazebosim/gz-sim/tree/main/examples/worlds)
- Source code of [integration tests](https://github.com/gazebosim/gz-sim/blob/main/test/integration)

## Entity Component Manager (ECM)

The gateway to interact with entities is through the
\ref gz::sim::EntityComponentManager
([source code](https://github.com/gazebosim/gz-sim/blob/main/include/gz/sim/EntityComponentManager.hh)),
ECM for short.
