...
parameters in the
[WheelSlip.hh](https://github.com/gazebosim/gz-sim/blob/main/src/systems/wheel_slip/WheelSlip.hh)
header file.

Gazebo has an example world that demonstrates the use of the wheel slip system,
namely [trisphere_cycle_wheel_slip.sdf](https://github.com/gazebosim/gz-sim/blob/main/examples/worlds/trisphere_cycle_wheel_slip.sdf).
...
parameters in the
[LookupWheelSlip.hh](https://github.com/gazebosim/gz-sim/blob/main/src/systems/lookup_wheel_slip/LookupWheelSlip.hh)
header file.

The [lookup_wheel_slip.sdf](https://github.com/gazebosim/gz-sim/blob/main/examples/worlds/lookup_wheel_slip.sdf).
