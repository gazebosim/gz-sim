 ...
 *
*/
#ifndef IGNITION_GAZEBO_SYSTEMS_WORLD_STATISTICS_HH_
...
namespace systems
{
  ...
  /** \class WorldStatistics WorldStatistics.hh \
   * ignition/gazebo/systems/WorldStatistics.hh
  **/
  /// \brief Base class for a System.
  class IGNITION_GAZEBO_VISIBLE WorldStatistics: public System
  {
    /// \brief Constructor
