...
/// `front()`
///   of the queue. The system always uses the most recently loaded valid
///   pointer.
/// - **Teardown**: When a plugin unloads, its specific descriptors are
/// surgically
///   removed from the queue. The system automatically falls back to the next
///   valid descriptor in the queue (if any), preventing segfaults.
