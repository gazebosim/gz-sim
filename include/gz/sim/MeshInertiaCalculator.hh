...
#ifndef GZ_SIM_MESH_INERTIA_CALCULATOR_HH_
#define GZ_SIM_MESH_INERTIA_CALCULATOR_HH_
        ...
        const common::Mesh* mesh)
{
  ...
  {
    Triangle triangle;
    triangle.v0 = vertArray[indArray[i]];
    triangle.v1 = vertArray[indArray[i+1]];
    triangle.v2 = vertArray[indArray[i+2]];
