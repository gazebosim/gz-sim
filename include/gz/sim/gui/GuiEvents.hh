...
namespace events
{
  ...
  class GZ_GAZEBO_GUI_VISIBLE EntitiesSelected : public QEvent
  {
    /// \brief Constructor
  ...
  class GZ_GAZEBO_GUI_VISIBLE DeselectAllEntities : public QEvent
  {
    /// \brief Constructor
    /// \param[in] _fromUser True if the event was directly generated by the
    /// user, false in case it's been propagated through a different mechanism.
  ...
  class GZ_GAZEBO_GUI_VISIBLE GuiNewRemovedEntities : public QEvent
  {
    /// \brief Constructor
  ...
  class GZ_GAZEBO_GUI_VISIBLE NewRemovedEntities : public QEvent
  {
    /// \brief Constructor
    /// \param[in] _newEntities Set of newly created entities
    /// \param[in] _removedEntities Set of recently removed entities
  ...
  class GZ_GAZEBO_GUI_VISIBLE TransformControlModeActive : public QEvent
  {
    /// \brief Constructor
  ...
  class GZ_GAZEBO_GUI_VISIBLE ModelEditorAddEntity : public QEvent
  {
    /// \brief Constructor
  ...
  class GZ_GAZEBO_GUI_VISIBLE VisualPlugin: public QEvent
  {
    /// \brief Constructor
