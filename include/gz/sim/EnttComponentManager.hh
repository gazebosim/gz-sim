 ...
 *
*/
#ifndef GZ_SIM_ENTTCOMPONENTMANAGER_HH_
#define GZ_SIM_ENTTCOMPONENTMANAGER_HH_
...
namespace gz
{
  namespace sim
  {
    ...
    class GZ_SIM_HIDDEN EnttComponentManagerPrivate;
    ...
    **/
    /// \brief The EnttComponentManager constructs, deletes, and returns
    /// components and entities.
    /// A component can be of any class which inherits from
    /// `components::BaseComponent`.
    class GZ_SIM_VISIBLE EnttComponentManager
    {
      /// \brief Constructor
     ...
     public: template<typename ComponentTypeT>
      ...
      /// \param[in] _other Original EnttComponentManager from which the diff
      /// was computed.
...
#include "gz/sim/detail/EnttComponentManager.hh"
