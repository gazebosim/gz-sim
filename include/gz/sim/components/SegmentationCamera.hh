 ...
 *
*/
#ifndef GZ_SIM_COMPONENTS_SEGMENTATIONCAMERA_HH_
#define GZ_SIM_COMPONENTS_SEGMENTATIONCAMERA_HH_
...
namespace components
{
  ...
  GZ_SIM_DECLARE_COMPONENT("gz_sim_components.SegmentationCamera",
      SegmentationCamera)
}
}
}
