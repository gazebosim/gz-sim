...
EntityComponentManager::EntityComponentManager(const ignition::gazebo::EntityComponentManager &_ecm)
{
  ...
  // _entity_component_manager = std::make_shared<ignition::gazebo::EntityComponentManager>();
}
...
{
  // _entity_component_manager.reset();
}
...
void define_gazebo_entity_component_manager(py::object module)
{
  ...
  // py::class_<ignition::gazebo::EntityComponentManager>(module, "EntityComponentManager")
  // .def(py::init<>());
