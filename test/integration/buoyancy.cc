...
/////////////////////////////////////////////////
// Marked collisions: a link that marks some of its collisions with
// gz:buoyancy="true" floats by those alone, whatever the <enable> list says.
namespace
{
...
/// \brief Path to one of the marked collision test worlds.
/// \param[in] _file World file name.
/// \return Its absolute path.
std::string MarkedWorld(const std::string &_file)
{
  return common::joinPaths(std::string(PROJECT_SOURCE_PATH),
      "test", "worlds", _file);
}
...
TEST_F(BuoyancyTest, GZ_UTILS_TEST_DISABLED_ON_WIN32(MarkedCollisions))
{
  TestFixture fixture(MarkedWorld("buoyancy_marked_collisions.sdf"));
...
TEST_F(BuoyancyTest, GZ_UTILS_TEST_DISABLED_ON_WIN32(MarkedSpawnedByAnyName))
{
  TestFixture fixture(MarkedWorld("buoyancy_marked_collisions.sdf"));
...
TEST_F(BuoyancyTest, GZ_UTILS_TEST_DISABLED_ON_WIN32(MarkedTakesPrecedence))
{
  TestFixture fixture(MarkedWorld("buoyancy_marked_default.sdf"));
...
TEST_F(BuoyancyTest, GZ_UTILS_TEST_DISABLED_ON_WIN32(MarkedInNestedModel))
{
  TestFixture fixture(MarkedWorld("buoyancy_marked_nested.sdf"));
...
TEST_F(BuoyancyTest, GZ_UTILS_TEST_DISABLED_ON_WIN32(MarkedSurvivesReset))
{
  TestFixture fixture(MarkedWorld("buoyancy_marked_collisions.sdf"));
