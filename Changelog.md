...
1. Add topic parameter to thrust plugin
    * [Pull request #1681](https://github.com/gazebosim/gz-gazebo/pull/1681)

1. Add information about `<topic>` system paramter
    * [Pull request #1671](https://github.com/gazebosim/gz-gazebo/pull/1671)

1. Adding tests for hydrodynamics
    * [Pull request #1617](https://github.com/gazebosim/gz-gazebo/pull/1617)

1. Fix Windows and Doxygen
    * [Pull request #1643](https://github.com/gazebosim/gz-gazebo/pull/1643)
