...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
  ...
  ENDIF()
    ...
    COMMAND ${LCOV_PATH} -q --remove ${_outputname}.info
      'test/*' '/usr/*' '*_TEST*' --output-file ${_outputname}.info
		COMMAND ${GENHTML_PATH} -q --legend -o ${_outputname}
      ${_outputname}.info
    COMMAND ${LCOV_PATH} --summary ${_outputname}.info 2>&1 | grep "lines" | cut -d ' ' -f 4 | cut -d '%' -f 1 > coverage/lines.txt
    COMMAND ${LCOV_PATH} --summary ${_outputname}.info 2>&1 | grep "functions" | cut -d ' ' -f 4 | cut -d '%' -f 1 > coverage/functions.txt
