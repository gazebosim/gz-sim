 ...
 *
 */
#ifndef GZ_GAZEBO_SYSTEMS_ACKERMANNODOMETRY_HH_
#define GZ_GAZEBO_SYSTEMS_ACKERMANNODOMETRY_HH_
...
{
  // Forward declaration
  class AckermannOdometryPrivate;
        ...
        public ISystemPostUpdate
  {
    ...
    /// \brief Destructor
    public: ~AckermannOdometry() override = default;
    ...
    private: std::unique_ptr<AckermannOdometryPrivate> dataPtr;
  };
  }
}
}
