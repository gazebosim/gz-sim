...
{
  // Forward declaration
  class MulticopterVelocityControlPrivate;
  ...
  {
    /// \brief Constructor
    public: MulticopterVelocityControl();

    /// \brief Destructor
    public: ~MulticopterVelocityControl() override = default;
    ...
    private: std::unique_ptr<MulticopterVelocityControlPrivate> dataPtr;
  };
  }
}
}
