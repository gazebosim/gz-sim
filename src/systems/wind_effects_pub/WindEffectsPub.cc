...
//////////////////////////////////////////////////
WindEffectsPub::WindEffectsPub() : System(),
...
//////////////////////////////////////////////////
WindEffectsPub::~WindEffectsPub() = default;

//////////////////////////////////////////////////
void WindEffectsPub::Configure(const Entity &_entity,
    const std::shared_ptr<const sdf::Element> &_sdf,
    EntityComponentManager &_ecm,
    EventManager &)
{
...
//////////////////////////////////////////////////
void WindEffectsPub::PreUpdate(const UpdateInfo &_info,
                            EntityComponentManager &_ecm)
{
...
GZ_ADD_PLUGIN(WindEffectsPub, System,
  WindEffectsPub::ISystemConfigure,
  WindEffectsPub::ISystemPreUpdate
)

GZ_ADD_PLUGIN_ALIAS(WindEffectsPub, "gz::sim::systems::WindEffectsPub")
