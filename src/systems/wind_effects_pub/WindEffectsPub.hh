 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_WINDEFFECTSPUB_HH_
#define GZ_SIM_SYSTEMS_WINDEFFECTSPUB_HH_
...
namespace systems
{
  ...
  ///
  class WindEffectsPub final:
    public System,
    public ISystemConfigure,
    public ISystemPreUpdate
  {
    /// \brief Constructor
    public: WindEffectsPub();

    /// \brief Destructor
    public: ~WindEffectsPub() final;
