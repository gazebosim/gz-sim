...
static const char kDefaultWorld[] =
  ...
  "<sdf version='1.6'>"
    "<world name='default'>"
      ...
      "    <ignition-gui>"
      "      <title>3D View</title>"
      "      <property type='bool' key='showTitleBar' value='false'/>"
      "      <property type='bool' key='resizable' value='false'/>"
      "      <property type='double' key='z' value='0'/>"
      ...
      "      <property type='bool' key='showTitleBar' value='false'/>"
      "      <property type='bool' key='resizable' value='false'/>"
      "      <property type='double' key='height' value='72'/>"
      "      <property type='double' key='width' value='121'/>"
      "      <property type='double' key='z' value='1'/>"
      "      <anchor line='left' target='window' target_line='left'/>"
      "      <anchor line='bottom' target='window' target_line='bottom'/>"
      "    </ignition-gui>"
      ...
      "      <property type='bool' key='showTitleBar' value='false'/>"
      "      <property type='bool' key='resizable' value='false'/>"
      "      <property type='double' key='height' value='110'/>"
      "      <property type='double' key='width' value='290'/>"
      "      <property type='double' key='z' value='1'/>"
      "      <anchor line='right' target='window' target_line='right'/>"
      "      <anchor line='bottom' target='window' target_line='bottom'/>"
      "    </ignition-gui>"
