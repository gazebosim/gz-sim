...
class myAxisAlignedBox : public math::AxisAlignedBox
{
...
class ExampleAxisAlignedBox : public ::testing::Test
{
  protected:
    virtual void SetUp()
    {
       box = math::AxisAlignedBox(math::Vector3d(0, -1, 2), math::Vector3d(1, -2, 3));
    }
...
{
  math::AxisAlignedBox *box = NULL;

  {
    box = new math::AxisAlignedBox;
    EXPECT_TRUE(box != NULL);
  }
...
{
  math::AxisAlignedBox defaultAxisAlignedBox1, defaultAxisAlignedBox2;
  ...
  EXPECT_FALSE(defaultAxisAlignedBox1.Intersects(math::AxisAlignedBox(
          math::Vector3d(0, 0, 0), math::Vector3d(1, 1, 1))));

  EXPECT_FALSE(defaultAxisAlignedBox2.Contains(math::Vector3d::Zero));
}

/////////////////////////////////////////////////
TEST(AxisAlignedBoxTest, Minus)
{
  math::AxisAlignedBox box1(1, 2, 3, 4, 5, 6);
  math::Vector3d sub(1, 1, 1);

  math::AxisAlignedBox box2 = box1 - sub;
...
TEST(AxisAlignedBoxTest, PlusEmpty)
{
  ...
  math::AxisAlignedBox box3 = box2 + box1;
...
{
  box.Merge(math::AxisAlignedBox(math::Vector3d(-1, -1, -1), math::Vector3d(2, 2, 2)));
  EXPECT_TRUE(box == math::AxisAlignedBox(math::Vector3d(-1, -2, -1),
                               math::Vector3d(2, 2, 3)));
}
...
{
  math::AxisAlignedBox box = math::AxisAlignedBox(math::Vector3d(1, 1, 1), math::Vector3d(3, 3, 3));
  math::AxisAlignedBox box2 = math::AxisAlignedBox(math::Vector3d(1, 1, 1), math::Vector3d(1, 3, 3));
  math::AxisAlignedBox box3 = math::AxisAlignedBox(math::Vector3d(0, 1, 1), math::Vector3d(1, 3, 3));
  EXPECT_TRUE(box == math::AxisAlignedBox(math::Vector3d(1, 1, 1),
        math::Vector3d(3, 3, 3)));
...
TEST(AxisAlignedBoxTest, OperatorNotEqual)
{
  ...
  math::AxisAlignedBox box2 = math::AxisAlignedBox(math::Vector3d(1, 1, 1), math::Vector3d(1, 3, 3));
  math::AxisAlignedBox box3 = math::AxisAlignedBox(math::Vector3d(0, 1, 1), math::Vector3d(1, 3, 3));
  EXPECT_FALSE(box != math::AxisAlignedBox(math::Vector3d(1, 1, 1),
        math::Vector3d(3, 3, 3)));
...
{
  math::AxisAlignedBox box = math::AxisAlignedBox(math::Vector3d(1, 1, 1), math::Vector3d(3, 3, 3));
  box += math::AxisAlignedBox(math::Vector3d(2, 2, 2), math::Vector3d(4, 4, 4));
  EXPECT_TRUE(box == math::AxisAlignedBox(math::Vector3d(1, 1, 1),
        math::Vector3d(4, 4, 4)));
}
...
{
  math::AxisAlignedBox box = math::AxisAlignedBox(math::Vector3d(1, 1, 1), math::Vector3d(4, 4, 4));
  box = box + math::AxisAlignedBox(math::Vector3d(-2, -2, -2), math::Vector3d(4, 4, 4));
  EXPECT_TRUE(box == math::AxisAlignedBox(math::Vector3d(-2, -2, -2),
                               math::Vector3d(4, 4, 4)));
}
...
{
  math::AxisAlignedBox box = math::AxisAlignedBox(math::Vector3d(0, 0, 0), math::Vector3d(1, 1, 1));

  EXPECT_FALSE(box.Intersects(math::AxisAlignedBox(
  ...
  EXPECT_TRUE(box.Intersects(math::AxisAlignedBox(
          math::Vector3d(0, 0, 0), math::Vector3d(1, 1, 1))));
}
...
{
  math::AxisAlignedBox b(0.1, 1.2, 2.3, 1.1, 2.2, 4.3);
...
{
  math::AxisAlignedBox b(0, 0, 0, 1, 1, 1);
