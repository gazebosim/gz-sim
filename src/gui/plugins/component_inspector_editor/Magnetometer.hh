 ...
 *
*/
#ifndef GZ_GAZEBO_GUI_COMPONENTINSPECTOR_MAGNETOMETER_HH_
#define GZ_GAZEBO_GUI_COMPONENTINSPECTOR_MAGNETOMETER_HH_
...
namespace sim
{
  ...
  class Magnetometer : public QObject
  {
    ...
    public: explicit Magnetometer(ComponentInspectorEditor *_inspector);
