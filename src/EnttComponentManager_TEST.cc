...
class EntityCompMgrTest : public EnttComponentManager
{
  ...
  public: void RunApplyDiff(const EnttComponentManager &_other,
...
/////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, InvalidComponentType)
{
...
//////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, RemoveEntity)
{
  // Create some entities
...
/////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, GZ_UTILS_TEST_DISABLED_ON_WIN32(State))
{
...
/////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, Descendants)
{
  // - 1
  //   - 2
  //   - 3
...
static void CompareEntityComponents(const EnttComponentManager &_ecm,
       ...
       GZ_UTILS_TEST_DISABLED_ON_WIN32(StateMsgUpdateComponent))
{
  ...
  EnttComponentManager originalECMStateMap;
  EnttComponentManager otherECMStateMap;
  ...
  EnttComponentManager originalECMState;
  EnttComponentManager otherECMState;
...
//////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, ComputeDiff)
{
...
//////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, ResetToWithDeletedEntity)
{
  Entity entity1 = manager.CreateEntity();
  math::Pose3d testPose{1, 2, 3, 0.1, 0.2, 0.3};
  manager.CreateComponent(entity1, components::Pose{testPose});
...
//////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, ResetToWithAddedEntity)
{
  Entity entity1 = manager.CreateEntity();
  math::Pose3d testPose{1, 2, 3, 0.1, 0.2, 0.3};
...
//////////////////////////////////////////////////
TEST_P(EnttComponentManagerFixture, EntityByName)
{
...
// problems.
INSTANTIATE_TEST_SUITE_P(EnttComponentManagerRepeat,
    EnttComponentManagerFixture, ::testing::Range(1, 10));
