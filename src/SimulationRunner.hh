...
namespace gz
{
  namespace sim
  {
    ...
    class GZ_SIM_VISIBLE SimulationRunner
    {
      ...
      /// This latch is monotonic: OnStop() sets it once and nothing ever
      /// clears it, so stopping is permanent for the lifetime of this object.
      /// Once set, Run() returns immediately without stepping, i.e. a
