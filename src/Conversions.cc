...
msgs::Entity_Type sim::convert(const std::string &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
math::Pose3d sim::convert(const msgs::Pose &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Collision sim::convert(const sdf::Collision &_in)
{
  msgs::Collision out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Collision sim::convert(const msgs::Collision &_in)
{
  sdf::Collision out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Geometry sim::convert(const sdf::Geometry &_in)
{
  msgs::Geometry out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Geometry sim::convert(const msgs::Geometry &_in)
{
  sdf::Geometry out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Material sim::convert(const sdf::Material &_in)
{
  msgs::Material out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Material sim::convert(const msgs::Material &_in)
{
  sdf::Material out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Actor sim::convert(const sdf::Actor &_in)
{
  msgs::Actor out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Actor sim::convert(const msgs::Actor &_in)
{
  sdf::Actor out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Light sim::convert(const sdf::Light &_in)
{
  msgs::Light out;
  out.set_name(_in.Name());
  msgs::Set(out.mutable_pose(), _in.RawPose());
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Light sim::convert(const msgs::Light &_in)
{
  sdf::Light out;
  out.SetName(_in.name());
  out.SetRawPose(msgs::Convert(_in.pose()));
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::GUI sim::convert(const sdf::Gui &_in)
{
  msgs::GUI out;
...
template<>
IGNITION_GAZEBO_VISIBLE
std::chrono::steady_clock::duration sim::convert(
    const msgs::Time &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Inertial sim::convert(const math::Inertiald &_in)
{
  msgs::Inertial out;
...
template<>
IGNITION_GAZEBO_VISIBLE
math::Inertiald sim::convert(const msgs::Inertial &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Axis sim::convert(const sdf::JointAxis &_in)
{
  msgs::Axis out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::JointAxis sim::convert(const msgs::Axis &_in)
{
  sdf::JointAxis out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Scene sim::convert(const sdf::Scene &_in)
{
  msgs::Scene out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Scene sim::convert(const msgs::Scene &_in)
{
  sdf::Scene out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Atmosphere sim::convert(const sdf::Atmosphere &_in)
{
  msgs::Atmosphere out;
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Atmosphere sim::convert(const msgs::Atmosphere &_in)
{
  sdf::Atmosphere out;
...
//////////////////////////////////////////////////
void sim::set(msgs::WorldStatistics *_msg,
...
//////////////////////////////////////////////////
template<>
msgs::Physics sim::convert(const sdf::Physics &_in)
{
  msgs::Physics out;
...
//////////////////////////////////////////////////
template<>
sdf::Physics sim::convert(const msgs::Physics &_in)
{
  sdf::Physics out;
...
//////////////////////////////////////////////////
void sim::set(msgs::SensorNoise *_msg, const sdf::Noise &_sdf)
{
  switch (_sdf.Type())
  {
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Noise sim::convert(const msgs::SensorNoise &_in)
{
  sdf::Noise out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::Sensor sim::convert(const sdf::Sensor &_in)
{
  msgs::Sensor out;
  out.set_name(_in.Name());
...
template<>
IGNITION_GAZEBO_VISIBLE
sdf::Sensor sim::convert(const msgs::Sensor &_in)
{
  sdf::Sensor out;
  out.SetName(_in.name());
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::WorldStatistics sim::convert(const sim::UpdateInfo &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
sim::UpdateInfo sim::convert(const msgs::WorldStatistics &_in)
{
  sim::UpdateInfo out;
...
template<>
IGNITION_GAZEBO_VISIBLE
msgs::AxisAlignedBox sim::convert(const math::AxisAlignedBox &_in)
{
...
template<>
IGNITION_GAZEBO_VISIBLE
math::AxisAlignedBox sim::convert(const msgs::AxisAlignedBox &_in)
{
