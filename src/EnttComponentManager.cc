...
class gz::sim::EnttComponentManagerPrivate
{
  ...
  */
  ...
  /// False otherwise
  /// \note This method should only be called in EnttComponentManager::Clone.
...
//////////////////////////////////////////////////
EnttComponentManager::EnttComponentManager()
...
//////////////////////////////////////////////////
EnttComponentManager::~EnttComponentManager() = default;

/*
//////////////////////////////////////////////////
void EnttComponentManagerPrivate::CopyFrom(
    const EnttComponentManagerPrivate &_from)
{
...
*/
//////////////////////////////////////////////////
size_t EnttComponentManager::EntityCount() const
{
...
/////////////////////////////////////////////////
Entity EnttComponentManager::Clone(Entity _entity, Entity _parent,
...
/////////////////////////////////////////////////
Entity EnttComponentManager::CloneImpl(Entity _entity, Entity _parent,
    const std::string &_name, bool _allowRename)
{
...
/////////////////////////////////////////////////
void EnttComponentManager::ClearRemovedComponents()
{
  std::lock_guard<std::mutex> lock(this->dataPtr->removedComponentsMutex);
...
{
  GZ_PROFILE("EnttComponentManager::RemoveComponent");
...
/////////////////////////////////////////////////
bool EnttComponentManager::EntityHasComponentType(const Entity _entity,
    const ComponentTypeId &_typeId) const
{
  if (!this->HasEntity(_entity))
    return false;
...
/*
/////////////////////////////////////////////////
bool EnttComponentManager::IsNewEntity(const Entity _entity) const
{
  std::lock_guard<std::mutex> lock(this->dataPtr->entityCreatedMutex);
...
/////////////////////////////////////////////////
bool EnttComponentManager::IsMarkedForRemoval(const Entity _entity) const
{
  std::lock_guard<std::mutex> lock(this->dataPtr->entityRemoveMutex);
  if (this->dataPtr->removeAllEntities)
  {
...
*/
/////////////////////////////////////////////////
ComponentState EnttComponentManager::ComponentState(const Entity _entity,
    const ComponentTypeId _typeId) const
{
...
/////////////////////////////////////////////////
bool EnttComponentManager::HasOneTimeComponentChanges() const
{
  return !this->dataPtr->oneTimeChangedComponents.empty();
}

/////////////////////////////////////////////////
bool EnttComponentManager::HasPeriodicComponentChanges() const
{
...
std::unordered_set<ComponentTypeId>
    EnttComponentManager::ComponentTypesWithPeriodicChanges() const
{
...
/////////////////////////////////////////////////
void EnttComponentManager::UpdatePeriodicChangeCache(
...
/////////////////////////////////////////////////
bool EnttComponentManager::CreateComponentImplementation(
...
/////////////////////////////////////////////////
components::BaseComponent *EnttComponentManager::ComponentImplementation(
    const Entity _entity, const ComponentTypeId _type)
{
  // Call the const version of the function
  return const_cast<components::BaseComponent *>(
      static_cast<const EnttComponentManager &>(
...
//////////////////////////////////////////////////
detail::BaseView *EnttComponentManager::AddView(
...
//////////////////////////////////////////////////
void EnttComponentManager::RebuildViews()
{
  GZ_PROFILE("EnttComponentManager::RebuildViews");
  for (auto &viewPair : this->dataPtr->views)
  {
    auto &view = viewPair.second.first;
    view->Reset();
...
//////////////////////////////////////////////////
void EnttComponentManager::AddEntityToMessage(msgs::SerializedState &_msg,
...
//////////////////////////////////////////////////
void EnttComponentManager::AddEntityToMessage(msgs::SerializedStateMap &_msg,
...
//////////////////////////////////////////////////
msgs::SerializedState EnttComponentManager::ChangedState() const
{
...
//////////////////////////////////////////////////
void EnttComponentManager::ChangedState(
...
//////////////////////////////////////////////////
void EnttComponentManager::State(
...
//////////////////////////////////////////////////
void EnttComponentManager::PeriodicStateFromCache(
  msgs::SerializedStateMap &_state,
...
{
  GZ_PROFILE("EnttComponentManager::SetState Non-map");
...
{
  GZ_PROFILE("EnttComponentManager::SetState Map");
  // Create / remove / update entities
...
//////////////////////////////////////////////////
void EnttComponentManager::SetAllComponentsUnchanged()
{
...
/////////////////////////////////////////////////
void EnttComponentManager::SetChanged(
    const Entity _entity, const ComponentTypeId _type,
...
/////////////////////////////////////////////////
bool EnttComponentManager::LockAddingEntitiesToViews() const
{
...
bool EnttComponentManagerPrivate::ClonedJointLinkName(Entity _joint,
    Entity _originalLink, EnttComponentManager *_ecm)
{
...
/////////////////////////////////////////////////
EntityComponentManagerDiff EnttComponentManager::ComputeEntityDiff(
...
/////////////////////////////////////////////////
void EnttComponentManager::ApplyEntityDiff(
    const EnttComponentManager &_other,
...
/////////////////////////////////////////////////
void EnttComponentManager::ResetTo(const EnttComponentManager &_other)
{
  auto ecmDiff = this->ComputeEntityDiff(_other);
  EnttComponentManager tmpCopy;
...
/////////////////////////////////////////////////
std::optional<Entity> EnttComponentManager::EntityByName(
