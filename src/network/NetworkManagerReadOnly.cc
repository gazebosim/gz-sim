...
//////////////////////////////////////////////////
NetworkManagerReadOnly::NetworkManagerReadOnly(const NetworkConfig &_config):
  NetworkManager(_config)
{
}

//////////////////////////////////////////////////
bool NetworkManagerReadOnly::Valid() const
{
...
//////////////////////////////////////////////////
std::string NetworkManagerReadOnly::Namespace() const
{
